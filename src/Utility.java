...
public class Utility {
	...
	*/
    ...
    /**
     * Metodo di supporto per verificare se la lista di interventi rispetta la 
     * priorità
     * @param array lista di interventi
     * @return true se la lista rispetta la priorità false in caso contrario
     */
    public static boolean checkPriority(int[] array){
    	 ...
    	 * utilizzo un metodo basato sul cambio degli stati
    	 * 
    	 */
    	/*
    	 * Nel prima caso se l'ultimo elemento della lista ha priorità 1 non devono
    	 * esserci altri cambiamenti di stato non potendo passare da una priorità 
    	 * alta ad una bassa
    	 */
    	if(first == 1){
